...
<body class="bg-gray-100">
    <div>
     <!-- Navbar dengan 3/4 lebar halaman -->
        <nav class="bg-white border-gray-200 dark:bg-gray-900 p-3 w-full mx-auto align-items-end text-center">
            <span class="text-2xl font-semibold dark:text-white">Dashboard Limbah Cair</span>
        </nav>
    </div>
                ...
                <!-- Card start -->
                 <div class="flex flex-row ">
                    <div class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 m-10">
                        ...
                        <p class="font-normal text-gray-700 dark:text-gray-400">2417.0 ppa</p>
                    </div>
                    <div class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 m-10">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">PH Air</h5>
                        <p class="font-normal text-gray-700 dark:text-gray-400">11</p>
                    </div>
                    <div class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 m-10">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Warna</h5>
                        <p class="font-normal text-gray-700 dark:text-gray-400">merah</p>
                    </div>
                </div>
